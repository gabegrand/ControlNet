...
#trainer = pl.Trainer(gpus=1, precision=32, callbacks=callbacks, default_root_dir=exp_dir, logger=wandb_logger)
trainer = pl.Trainer(gpus=3, accelerator="gpu", strategy="ddp", precision=32, callbacks=callbacks, default_root_dir=exp_dir)
